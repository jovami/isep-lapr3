...
BEGIN
    ...
    INSERT INTO guarda_processo_leitura_dados(data_hora_execucao,numero_registos_lidos,numero_registos_inseridos,numero_registos_nao_inseridos)
                                             VALUES
                                             (CURRENT_TIMESTAMP,CONTADOR_REGISTOS_LIDOS,CONTADOR_REGISTOS_INSERIDOS,CONTADOR_REGISTOS_NAO_INSERIDOS);
    
    dbms_output.put_line('Data e hora de execucao do processo = ' || CURRENT_TIMESTAMP);
...
Data e hora de execucao do processo = 04-JAN-23 04.48.22.990240000 PM EUROPE/LONDON
