...
estrutural ou n\~ao influenciou na escolha do materiais na camada estrutural. % TODO: why?
...
% Como isolante, optou-se por utilizar o \textbf{poliestireno extrudido}, devido ao seu
% excelente desempenho t\'ermico ($ k = 0.033 \hspace{1mm} Wm^{-1}K^{-1} $)~\cite{poliestireno_k},
% \`a facilidade e rapidez de instala\c{c}\~ao~\cite{poliestireno} e pelo facto de cumprir as
% exig\^encias ambientais DAP\footnote{https://en.wikipedia.org/wiki/Environmental\_Product\_Declaration}.
...
utilizar a \textbf{Madeira Pinus} % TODO: why
